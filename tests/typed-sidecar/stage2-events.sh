...
test "$diagnostic_cases" -eq 65 ||
    fail "expected all 65 Stage 2 diagnostic fixtures, saw $diagnostic_cases"
...
test "$repository_error_cases" -eq 385 ||
    fail "expected all 385 repository error companions, saw $repository_error_cases"
