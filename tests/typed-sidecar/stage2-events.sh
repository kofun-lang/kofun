...
test "$diagnostic_cases" -eq 61 ||
    fail "expected all 61 Stage 2 diagnostic fixtures, saw $diagnostic_cases"
...
test "$repository_error_cases" -eq 339 ||
    fail "expected all 339 repository error companions, saw $repository_error_cases"
