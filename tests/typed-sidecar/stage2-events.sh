...
test "$diagnostic_cases" -eq 105 ||
    fail "expected all 105 Stage 2 diagnostic fixtures, saw $diagnostic_cases"
...
test "$repository_error_cases" -eq 449 ||
    fail "expected all 449 repository error companions, saw $repository_error_cases"
