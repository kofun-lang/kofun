...
test "$diagnostic_cases" -eq 85 ||
    fail "expected all 85 Stage 2 diagnostic fixtures, saw $diagnostic_cases"
...
test "$repository_error_cases" -eq 422 ||
    fail "expected all 422 repository error companions, saw $repository_error_cases"
