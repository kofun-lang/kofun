...
test "$diagnostic_cases" -eq 101 ||
    fail "expected all 101 Stage 2 diagnostic fixtures, saw $diagnostic_cases"
...
test "$repository_error_cases" -eq 445 ||
    fail "expected all 445 repository error companions, saw $repository_error_cases"
