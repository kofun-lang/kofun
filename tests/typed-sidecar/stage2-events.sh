...
test "$diagnostic_cases" -eq 81 ||
    fail "expected all 81 Stage 2 diagnostic fixtures, saw $diagnostic_cases"
...
test "$repository_error_cases" -eq 416 ||
    fail "expected all 416 repository error companions, saw $repository_error_cases"
