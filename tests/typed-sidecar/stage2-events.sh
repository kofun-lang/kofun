...
test "$diagnostic_cases" -eq 55 ||
    fail "expected all 55 Stage 2 diagnostic fixtures, saw $diagnostic_cases"
...
test "$repository_error_cases" -eq 329 ||
    fail "expected all 329 repository error companions, saw $repository_error_cases"
