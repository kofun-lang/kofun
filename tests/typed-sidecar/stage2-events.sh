...
test "$diagnostic_cases" -eq 70 ||
    fail "expected all 70 Stage 2 diagnostic fixtures, saw $diagnostic_cases"
...
test "$repository_error_cases" -eq 390 ||
    fail "expected all 390 repository error companions, saw $repository_error_cases"
