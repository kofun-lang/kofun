...
test "$diagnostic_cases" -eq 77 ||
    fail "expected all 77 Stage 2 diagnostic fixtures, saw $diagnostic_cases"
...
test "$repository_error_cases" -eq 397 ||
    fail "expected all 397 repository error companions, saw $repository_error_cases"
