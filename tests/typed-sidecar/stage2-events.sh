...
test "$diagnostic_cases" -eq 66 ||
    fail "expected all 66 Stage 2 diagnostic fixtures, saw $diagnostic_cases"
...
test "$repository_error_cases" -eq 386 ||
    fail "expected all 386 repository error companions, saw $repository_error_cases"
