...
| `bounded-bytes` | rejection | `tests/conformance/bytes-mutation/same_carrier.kofun` | In the direct builtin fixture, one resolved BindingId in both append_range positions is refused as E2S177 before C is committed; wrapper-level alias exclusivity remains outside this observation (#1561). |
