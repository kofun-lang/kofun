...
| `nominal-records` | rejection | `tests/conformance/records/stage2_unsupported_field.kofun` | The production Stage 2 C11 path refuses a field type outside its Int/Bool slice before emitting an artifact. |
