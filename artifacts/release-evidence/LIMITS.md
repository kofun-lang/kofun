...
| `bounded-bytes` | rejection | `tests/conformance/bytes-mutation/same_carrier.kofun` | One value in both positions of append_range is refused as E2S177 and commits no C. |
