...
| `bounded-bytes` | `task bounded-bytes` | The sequential aggregate runs the carrier gate's tracked owner, cleanup, transfer, and refusal fixtures before the mutation gate's checked-in direct helper, growth, range, transactionality, and E2S177 fixtures. The observation is fixture-bounded and leaves the specification's known gaps open. |
