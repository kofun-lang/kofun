...
| `bounded-bytes` | `task bounded-bytes` | PASS: growth 0->16, every doubling edge, the ceiling, one over it, reserve, and clear-capacity preservation hold; injected OOM preserves pointer and bytes for append_range source and destination too |
