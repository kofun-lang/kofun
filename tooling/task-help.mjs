...
export const GROUPS = Object.freeze([
    ...
    },
    {
        ...
        tasks: [
            ...
            'stage2-pair-host-primitives-decision', 'stage2-pair-host-primitives',
            'stage2-pair-refresh',
            ...
            'wasi-command-projection-contract', 'wasi-command-backend-shell', 'wasi-command-memory',
    ...
    },
    {
        ...
        tasks: [
            ...
            'text-results', 'int-bits', 'int-bits-lowering', 'list-int-values', 'record-values', 'text-escapes', 'unused-function', 'bounded-bytes', 'bytes-carrier', 'bytes-mutation', 'bytes-read-file', 'bytes-text', 'authority-type-carrier', 'while-list-int', 'else-if-chain',
            'list-int-signatures',
    ...
    },
    {
        ...
        tasks: [
            ...
            'benchmark-summary', 'benchmark-report-spec', 'benchmark-report-model', 'benchmark-report-codec',
