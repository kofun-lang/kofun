...
actual_digest=$("$repo_root/bin/kofun-sha256" bootstrap/stage1/compiler.kofun | awk '{ print $1 }')
...
test "$("$repo_root/bin/kofun-sha256" bootstrap/selfhost/driver/corpus_answer.c |
    awk '{ print $1 }')" = \
...
"$temporary/kofun-stage2" --selfhost-compile \
    ...
    "$("$repo_root/bin/kofun-sha256" bootstrap/selfhost/frontend/reject_unsupported_match.kofun |
