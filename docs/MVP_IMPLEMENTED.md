...
| bounded benchmark report v1 model, Bytes codec, and comparison | bounded C11 Stage 2: 49 fields, 100 samples in 64+36 segments, canonical Bytes and explicit threshold comparison; no live runner, providers, filesystem publication, generic JSON, or other backend | `task benchmark-report` | `benchmark-report-v1` |
